...
<br><br>To send data between actvities/fragments Safe args Gradle plugin is used.
...
<br><br>App also shows handling deep links with navigation component. Click on an icon in right corner of toolbar creates a notification. After clicking on the notification, user is taken to DeepLinkFragment.
